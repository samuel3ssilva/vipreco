...
import { DemoPill } from "@/components/StagingBanner";
...
export function AppShell({
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-background">
      ...
      {/* V4 §16 — a identificação de demo saiu da faixa própria e virou a pill ao lado da
          marca, dentro do header. Mesma semântica, uma linha inteira a menos antes do
          conteúdo. Ver `DemoPill`. */}
      <header
